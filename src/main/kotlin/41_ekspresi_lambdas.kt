fun main() {
    //Ekspresi lambda selalu dikelilingi oleh tanda blok „{}‟ deklarasi parameter berada dalam blok yang memiliki opsional type annotation pada bagian tubuh blok ditandai dengan tanda „->‟. 
